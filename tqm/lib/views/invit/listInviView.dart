...
import 'package:tqm/services/Stratege/InitiativeService.dart';
...
InitiativeService _initiativeService = InitiativeService();

class InviView extends StatefulWidget {
  @override
...
class _StratgeViewState extends State<InviView> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

  ScrollController controller;
  Future<List<InitiativeModel>> data;
  ...
  getData() async {
    setState(() {
      data = _initiativeService.getData();
    });
  }

  @override
  Widget build(BuildContext context) {
    Widget iii = StreamBuilder<List<InitiativeModel>>(
...
Widget strCard(InitiativeModel model) {
  return Card(
    child: Container(
